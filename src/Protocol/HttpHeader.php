...
class HttpHeader
{
     ...
     * Response header used to confirm the image device to pixel ratio in requests
     * where the DPR client hint was used to select an image resource.
     *
     ...
     * only if it has been modified after the given date. This is used to transmit
     * data only when the cache is out of date.
     *
     * Category: Conditionals
     * Standard: -
     * Status: Official
    ...
    /**
     * HTTP header 'Expect'
     * Indicates expectations that need to be fulfilled by the server to properly
     * handle the request.
     *
     * Category: Controls
     * Standard: -
    ...
    /**
     * HTTP header 'Cookie2'
     * Contains an HTTP cookie previously sent by the server with the Set-Cookie2
     * header, but has been obsoleted. Use Cookie instead.
     *
     * Category: Cookies
     * Standard: -
     * Status: Official
     ...
     * (default behavior without the header), or if it should be handled like a
     * download and the browser should present a “Save As” dialog.
     *
     * Category: Downloads
     * Standard: -
     * Status: Official
     ...
     * header, they are requesting that Chrome check that any certificate for
     * that site appears in public CT logs.
     *
     * Category: Security
     * Standard: -
     * Status: Official
     ...
     * should not display the option to "Open" a file that has been downloaded
     * from an application, to prevent phishing attacks as the file otherwise
     * would gain access to execute in the context of the application.
     ...
     * be restricted due to the Same-Origin Policy. See the Cross-domain Policy
     ...
     * information about them while not providing any usefulness to the application
     * or its visitors. Unset this header to avoid exposing potential vulnerabilities.
     *
     * Category: Security
     * Standard: -
     * Status: Official
     ...
     * It is a request header that indicates whether a navigation request
     * was triggered by user activation. It is a Structured Header whose value
     * is a boolean so possible values are ?0 for false and ?1 for true.
     *
     * Category: Fetch metadata request headers
     * Standard: -
     * Status: Official
     ...
     * paintworklet, report, script, serviceworker, sharedworker, style, track,
     * video, worker, and xslt.
     *
     * Category: Fetch metadata request headers
     * Standard: -
     * Status: Official
